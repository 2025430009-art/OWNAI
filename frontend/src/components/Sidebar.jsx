...
export default function Sidebar({
  ...
  if (collapsed) {
    return (
      <aside className="flex w-14 shrink-0 flex-col items-center border-r border-stone-200 bg-[#ebeae6] py-3 dark:border-slate-800 dark:bg-slate-900">
        <button
          type="button"
  ...
  return (
    <aside className="flex w-[260px] shrink-0 flex-col border-r border-stone-200 bg-[#ebeae6] dark:border-slate-800 dark:bg-slate-900">
